...
\item[Behavior clustering:] %TODO use full dataset?
...
Furthermore, we calculate the "Number of trips" attribute which counts the trip records each user has in a day. Figure \ref{fig:preprocessing/num_trips} shows the distribution of this attribute on a random weekday. We note that most people perform two trips per day, followed by people who perform only one trip a day. %TODO plot for busuiest day
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{.7\textwidth}
  	\centering
  	\includegraphics[width=.8\linewidth]{"./images/Cummulative lines vocabulary size"}
  	\caption{Vocabulary containing subway lines and bus routes}
  \end{subfigure}
  \begin{subfigure}[b]{.7\textwidth}
  	\centering
  	\includegraphics[width=.8\linewidth]{"./images/Cummulative stops vocabulary size"}
...
Examples of parsed routes for each mode of transportation are shown in Figure \ref{fig:preprocessing/parsed_routes}. %TODO chinese latex!
...
%TODO change and comment on matrices
...
%TODO check level of competency with other studies
