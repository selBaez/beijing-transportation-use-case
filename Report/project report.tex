...
From both of the above, the large presence of commuters and their known needs, it follows that identifying commuters can help in creating a sustainable public transportation network. Long term planning and policies for improving the overall experience can come as a consequence to aid urban areas on a large scale.
...
In the aspect of social resources, one of the main complications is the one of mobility. In Beijing, public transport is the dominant mode of transportation, accounted for 44.0\% of all trips compared to 32.6\% attributed to private cars \cite{mao2016commuting}. Though it is continually expanding, it is a fact that public transport is overcrowded, constantly reaching over 100\% capacity. \selfnote{reference}
...
Looking at the social context of Beijing, there are several reasons justifying the study of commuters. 
...
Mobility in metropolitan areas follows swarm behaviors. Based on individual travels and routines, travelers exhibit distinguishable characteristics on a larger scale. Both levels of understanding are crucial for Transportation experts.

Surveys are widely used in metropolitan transportation studies in order to reach travelers on an individual level, while aggregated measurements are used to analyze their collective behavior. The analysis is usually done with statistical methodology. 
